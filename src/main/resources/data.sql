...
INSERT INTO likes (id, user_fk_id, post_fk_id, comment_fk_id) VALUES (0, 1, 0, null);
INSERT INTO likes (id, user_fk_id, post_fk_id, comment_fk_id) VALUES (1, 1, null, 0);
INSERT INTO likes (id, user_fk_id, post_fk_id, comment_fk_id) VALUES (2, 1, null, 1);
INSERT INTO likes (id, user_fk_id, post_fk_id, comment_fk_id) VALUES (3, 2, 0, null);
INSERT INTO likes (id, user_fk_id, post_fk_id, comment_fk_id) VALUES (4, 2, null, 0);
INSERT INTO likes (id, user_fk_id, post_fk_id, comment_fk_id) VALUES (5, 2, null, 1);
...
INSERT INTO user_dialog (id, dialog_fk_id, user_fk_id, text) VALUES (0, 0, 1, 'Привет))');
INSERT INTO user_dialog (id, dialog_fk_id, user_fk_id, text) VALUES (1, 0, 2, 'Здороуууу');
INSERT INTO user_dialog (id, dialog_fk_id, user_fk_id, text) VALUES (2, 0, 1, 'Как твои дела, мне интересно?');
INSERT INTO user_dialog (id, dialog_fk_id, user_fk_id, text) VALUES (3, 0, 2, 'Ниче не понял че ты написала)');
INSERT INTO user_dialog (id, dialog_fk_id, user_fk_id, text) VALUES (4, 0, 1, 'Ну и пока тогда, козел!');
INSERT INTO user_dialog (id, dialog_fk_id, user_fk_id, text) VALUES (5, 1, 1, 'Чат пуст))');